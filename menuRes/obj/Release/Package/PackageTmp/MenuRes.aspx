<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuRes.aspx.cs" Inherits="menuRes.MenuRes" %>
...
<head>
    ...
    <link rel="icon" type="image/png" href="Imagenes/iconos/restaurante.png">
        ...
        <link rel="stylesheet" href="Estilos/estiloMenuRes.css"/>
...
<script>
    $(document).ready(function () {
        ...
        function updateCart() {
            ...
            for (var i = 0; i < cartItems.length; i++) {
                ...
                var row = "<tr>" +
                    ...
                    "<td>" + item.quantity + "</td>" +
                    "<td>" +
                    "<button class='btn-sumar' data-item-index='" + i + "'></button>" +
                    "<button class='btn-quitar' data-item-index='" + i + "'></button>" +
                    "<button class='btn-eliminar' data-item-index='" + i + "'></button>" +
                    "</td>" +
                    "</tr>";
        ...
        $(".addToCartBtn").on("click", function (event) {
            ...
            var button = $(this);
            button.addClass("hover-effect");

            setTimeout(function () {
                button.removeClass("hover-effect");
        ...
        $("#checkoutBtn").on("click", function () {
            if (cartItems.length === 0) {
                ...
                var url = "pago.aspx?id=" + encodeURIComponent($("#<%= restauranteIdHiddenField.ClientID %>").val()) + "&";
                for (var i = 0; i < cartItems.length; i++) {
                    var item = cartItems[i];
...
<body>
    <!------------------------------------------------------------------------------- NAVBAR -------------------------------------------------------------------------->
        ...
        <div class="navbar transparent">
            <div class="navbar-left">
                ...
                <a href="index.aspx">SR COMPANY</a>
            </div>
            <div class="nav-nombre">
                  <asp:Literal ID="nombreRestauranteLiteral" runat="server"></asp:Literal>
            </div>
            <div class="navbar-right">
              <button class="btn btn-pagar ml-auto btn-cart" data-toggle="modal" data-target="#cartModal">
        ...
        <div id="menu" class="menu" runat="server">
            <span class="fas fa-times" onclick="toggleMenu()" style="position: absolute; top: 10px; right: 10px; font-size: 24px; cursor: pointer; color:black;"></span>
            <div class="modal-header2">SR Company</div>
        </div>
    ...
    <!------------------------------------------------------------------------------- TARJETAS COMIDA -------------------------------------------------------------------------->
        ...
        <form id="form1" runat="server">
            <div class="container mt-5">
                <div class="row" id="tarjetasComida">
                    <asp:Literal ID="litTarjetas" runat="server" />
                </div>
            </div>
            <asp:HiddenField ID="restauranteIdHiddenField" runat="server" />
        </form>
    <!------------------------------------------------------------------------------- MODAL CARRITO -------------------------------------------------------------------------->
            ...
            <div class="modal-dialog modal-dialog-right" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="cartModalLabel" style="color: black;">Resumen del Carrito</h5>
                    ...
                    <div class="modal-body" >
                        ...
                        <p class="text-right" style="color: white;">Total: <span id="cartTotal">0</span>€</p>
                        <div id="emptyCartMessage" class="text-center" style="display:none;">
                              No hay artículos en tu carrito.
                        </div>
                     </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-pagar" id="checkoutBtn">Pagar</button>
                    </div>
                </div>
            </div>
        </div>
    <!------------------------------------------------------------------------------- TOAST -------------------------------------------------------------------------->
       ...
       <div class="toast" id="cartToast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3000">
